...
const regions: RegionData[] = [
  {
    ...
    nameEn: "Singapore",
    law: "PDPA",
    maxPenalty: "SGD 1,000,000",
    dpoRequired: "强制要求",
    dataLocalization: "无强制要求",
    keyPoints: ["同意义务严格", "跨境传输需保障", "72小时违规通报"],
    riskLevel: "high",
  },
  {
    name: "泰国",
    nameEn: "Thailand",
    law: "PDPA",
    maxPenalty: "THB 5,000,000",
    dpoRequired: "特定情况要求",
    dataLocalization: "部分行业要求",
    keyPoints: ["2022年全面生效", "员工培训义务", "敏感数据额外保护"],
    riskLevel: "medium",
  },
  {
    name: "马来西亚",
    nameEn: "Malaysia",
    law: "PDPA 2010",
    maxPenalty: "MYR 500,000",
    dpoRequired: "无强制要求",
    dataLocalization: "需当地存储",
    keyPoints: ["数据不出境原则", "7项数据原则", "刑事责任可能"],
    riskLevel: "medium",
  },
  {
    name: "越南",
    nameEn: "Vietnam",
    law: "Decree 13/2023",
    maxPenalty: "VND 100,000,000",
    dpoRequired: "特定情况要求",
    dataLocalization: "强制本地化",
    keyPoints: ["新法2023生效", "影响评估义务", "本地存储强制"],
    riskLevel: "high",
  },
  {
    name: "印度尼西亚",
  ...
  },
  {
    ...
    nameEn: "Philippines",
    law: "DPA 2012",
    maxPenalty: "PHP 5,000,000",
    dpoRequired: "强制要求",
    dataLocalization: "无强制要求",
    keyPoints: ["NPC 监管严格", "违规报告义务", "敏感数据高标准"],
    riskLevel: "medium",
  },
];
